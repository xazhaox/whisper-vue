<template>
  <a-drawer v-model="drawerVisible" title="布局设置">
    ...
    <div class="layout-box">
      <a-tooltip effect="dark" content="纵向" placement="top" :show-after="200">
    ...
    <div class="theme-item">
      <span>
        侧边栏反转色
        <a-tooltip effect="dark" content="侧边栏颜色变为深色模式" placement="top">
          <QuestionCircleFilled />
        </a-tooltip>
      </span>
      <a-switch v-model="asideInverted" @change="setAsideTheme" />
    </div>
    <div class="theme-item mb50">
      <span>
        头部反转色
        <a-tooltip effect="dark" content="头部颜色变为深色模式" placement="top">
          <QuestionCircleFilled />
        </a-tooltip>
      </span>
      <a-switch v-model="headerInverted" @change="setHeaderTheme" />
    </div>
    ...
    <div class="theme-item">
      <span>灰色模式</span>
      <a-switch v-model="isGrey" @change="changeGreyOrWeak('grey', !!$event)" />
    </div>
    <div class="theme-item mb40">
      <span>色弱模式</span>
      <a-switch v-model="isWeak" @change="changeGreyOrWeak('weak', !!$event)" />
    </div>
    ...
    <div class="theme-item">
      <span>菜单手风琴</span>
      <a-switch v-model="accordion" />
    </div>
    <div class="theme-item">
      <span>水印</span>
      <a-switch v-model="watermark" />
    </div>
    <div class="theme-item">
      <span>面包屑</span>
      <a-switch v-model="breadcrumb" />
    </div>
    <div class="theme-item">
      <span>面包屑图标</span>
      <a-switch v-model="breadcrumbIcon" />
    </div>
    <div class="theme-item">
      <span>标签栏</span>
      <a-switch v-model="tabs" />
    </div>
    <div class="theme-item">
      <span>标签栏图标</span>
      <a-switch v-model="tabsIcon" />
    </div>
    <div class="theme-item">
      <span>页脚</span>
      <a-switch v-model="footer" />
    </div>
  </a-drawer>
</template>
